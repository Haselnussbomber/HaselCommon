...
public class HaselSeString
{
    ...
    public HaselSeString Resolve(List<HaselSeString>? localParameterData = null)
    {
        return new(Payloads.SelectMany(payload => payload.Resolve(localParameterData).Payloads).ToList());
    }
