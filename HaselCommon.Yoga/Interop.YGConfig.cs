...
public static unsafe partial class Interop
{
    ...
    /// <summary>
    /// eturns the default config values set by Yoga.
    /// </summary>
    [DllImport(YogaDll, CallingConvention = CallingConvention.Cdecl)]
    ...
    /// <br/>
    /// By deafult Yoga will prioritize W3C conformance. `Errata` may be set to ask Yoga to produce specific incorrect behaviors. E.g. `YGConfigSetErrata(config, <see cref="Errata.StretchFlexBasis"/>)`.<br/>
    /// <br/>
    /// YGErrata is a bitmask, and multiple errata may be set at once. Predfined constants exist for convenience:<br/>
    /// <list type="table">
    ///   <item>
    ///     <term><see cref="Errata.None"/></term>
    ///     <description>No errata</description>
    ///   </item>
    ///   <item>
    ///     <term><see cref="Errata.Classic"/></term>
    ///     <description>Match layout behaviors of Yoga 1.x</description>
    ///   </item>
    ///   <item>
    ///     <term><see cref="Errata.All"/></term>
    ///     <description>Match layout behaviors of Yoga 1.x, including `UseLegacyStretchBehaviour`</description>
    ///   </item>
    /// </list>
    /// </summary>
    [DllImport(YogaDll, CallingConvention = CallingConvention.Cdecl)]
    public static extern void YGConfigSetErrata(YGConfig* config, Errata errata);

    /// <summary>
    /// Get the currently set errata.
    /// </summary>
    [DllImport(YogaDll, CallingConvention = CallingConvention.Cdecl)]
    public static extern Errata YGConfigGetErrata(YGConfig* config);
    ...
    /// </summary>
    [DllImport(YogaDll, CallingConvention = CallingConvention.Cdecl)]
    public static extern void YGConfigSetExperimentalFeatureEnabled(YGConfig* config, ExperimentalFeature feature, bool enabled);

    /// <summary>
    /// Whether an experimental feature is set.
    /// </summary>
    [DllImport(YogaDll, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool YGConfigIsExperimentalFeatureEnabled(YGConfig* config, ExperimentalFeature feature);
