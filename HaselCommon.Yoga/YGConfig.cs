...
public unsafe struct YGConfig : IDisposable
{
    ...
    /// <inheritdoc cref="Interop.YGConfigSetErrata(YGConfig*, Errata)"/>
    ...
    /// <inheritdoc cref="Interop.YGConfigSetExperimentalFeatureEnabled(YGConfig*, ExperimentalFeature, bool)"/>
    public void SetContext(ExperimentalFeature feature, bool enabled)
    {
        fixed (YGConfig* ptr = &this)
            Interop.YGConfigSetExperimentalFeatureEnabled(ptr, feature, enabled);
    }

    /// <inheritdoc cref="Interop.YGConfigIsExperimentalFeatureEnabled(YGConfig*, ExperimentalFeature)"/>
